...
public class ElementoAConfirmar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elemento_aconfirmar);
            ...
            public void onResponse(Call<Elemento> call, Response<Elemento> response) {
                if (response.isSuccessful()) {
                    ...
                    if(response.body() != null) {
                        ...
                        //Confirmar elemento por este usuario
                        boton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                apiService.confirmacion(id, elemento.getIdElemento()).enqueue(new Callback<Elemento>() {
                                    @Override
                                    public void onResponse(Call<Elemento> call, Response<Elemento> response) {
                                        Intent intentSug = new Intent(ElementoAConfirmar.this, ConfirmarActivity.class);
                                        ElementoAConfirmar.this.startActivity(intentSug);
                                        finish();
                                    }
